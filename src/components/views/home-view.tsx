    ...
    <div className="flex flex-col">
      ...
      <section className="mx-auto max-w-6xl w-full px-4 sm:px-6 py-12">
        <SectionTitle
          ...
          desc="آخرین چیزهایی که بافتم. خیلی‌هاشون تک‌نسخه‌ان، پس هرچه زودتر خرید کنید."
          action={
            <button
              onClick={() => navigate("/shop")}
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            <div className="md:col-span-7">
              ...
              <p className="text-canvas/80 leading-8 mb-6 max-w-lg">
                پرداخت کارت‌به‌کارت انجام می‌شه — کافیه واریز کنید و رسیدش رو آپلود کنید. من هم
                سفارشت رو ثبت می‌کنم، رسید رو بررسی می‌کنم (معمولاً کمتر از {toFa(2)} ساعت در ساعات
                کاری) و بعد طبق مراحل براتون ارسال می‌کنم.
              </p>
              <button
                onClick={() => navigate("/shop")}
